...
/*!
 * \file
 * \brief Ce module permet de manipuler des arbre binaire de recherche.
 *
 * La stucture est à deux niveaux:
 * \li une structure accessible par pointeur/référence de l'extérieur avec les
 * pointeurs sur les bonnes fonctions, et
 ...
 *
 * Selon la nature de cette fonction (et des valeurs insérées), les valeurs
 * manipulées peuvent être simple ou des couples (clé,valeur) avec la
 * comparaison sur les clés uniquement.
...
/*! Les structure sont manipulés par pointer/référence.
 */
typedef struct arbre_struct *arbre;

/*!
 * Cette fonction retourne un arbre vide.
 * \param copier une fonction pour copier une valeur, un pointeur est indiqué
 * pour la relier
 * \param detruire une fonction pour détruire une valeur, le pointeur est
 * indiqué pour la mettre à jour
...
/*!
 * Cette fonction insère (une copie) d'une valeur dans un arbre binaire de
 * recherche.
...
/*!
 * Cette fonction affiche les valeurs contenues dans un arbre sur une ligne
...
/*!
 * La fonction renvoie le champ val du noeud trouvé ou NULL si aucun noeud ne
 * contient un champ val de même clé.
